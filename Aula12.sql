...
-- REGISTROS DUPLICADOS E GARANTINDO A 
-- INTEGRIDADE DOS DADOS

-- GERALMENTE A CHAVE PRIMARIA É UMA COLUNA POR NOME ID
...
-- CRIANDO A TABELA CIDADES COM PRIMARY-KEY
-- NOT NULL: GARANTE QUE A COLUNA NAO PODE TER VALORES NULOS
...
-- AO INVES DE PASSARMOS O VALOR DO ID NO INSERT USAMOS
...
-- ASSIM NAO PRECISAMOS FORNECER ESSE VALOR MANUALMENTE
...
-- ESSA SEQUENCE SERÁ USADA NA COLUNA ID_CID DA TABELA CIDADES
...
-- TRIGGER: É UMA ACAO AUTOMATICA (GATILHO) QUE OCORRE QUANDO ALGO
...
-- E PREENCHE ESSE VALOR NA COLUNA ID_CID
